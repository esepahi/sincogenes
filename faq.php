...
<div id="content" style="background-color:#f3f3f5;" >
<div class="faqera">
<section class="cd-faq">
	<ul class="cd-faq-categories">
		<li><a class="selected" href="#basics">Basics Knowledge</a></li>
		<li><a href="#about">Homology recognition</a></li>
		<li><a href="#search">Database content</a></li>
		<li><a href="#blast">Blast and Analyze</a></li>
		<li><a href="#browse">Browse and download</a></li>
		<li><a href="#cite">How to cite</a></li>
	</ul> <!-- cd-faq-categories -->
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Basics Knowledge</h2></li>
			<li>
				<a class="cd-faq-trigger" href="#0">What is in-genome homology?</a>
			...
			<li>
				<a class="cd-faq-trigger" href="#0">where do terms paralog and single-copy come from?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">What are the benefits of knowing in-genome homology?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Where can I find more resources about in-genome homology?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
				</div> <!-- cd-faq-content -->
			</li>
		...
		<ul id="about" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Homology recognition</h2></li>
			<li>
				<a class="cd-faq-trigger" href="#0">What are common methods for homology recognition?</a>
				<div class="cd-faq-content">
					<p>There are two strategies for homology recognition. 1. Blast based and 2. chichi based? blabla bla bla </p>
				</div> <!-- cd-faq-content -->
			</li>

			<li>
				<a class="cd-faq-trigger" href="#0">How do you recognize homology from protein sequences?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">How do you recognize homology from RNA-Seq sequences?</a>
				<div class="cd-faq-content">
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi tempore, placeat quisquam rerum! Eligendi fugit dolorum tenetur modi fuga nisi rerum, autem officiis quaerat quos. Magni quia, quo quibusdam odio. Error magni aperiam amet architecto adipisci aspernatur! Officia, quaerat magni architecto nostrum magnam fuga nihil, ipsum laboriosam similique voluptatibus facilis nobis? Eius non asperiores, nesciunt suscipit veniam blanditiis veritatis provident possimus iusto voluptas, eveniet architecto quidem quos molestias, aperiam eum reprehenderit dolores ad deserunt eos amet. Vero molestiae commodi unde dolor dicta maxime alias, velit, nesciunt cum dolorem, ipsam soluta sint suscipit maiores mollitia assumenda ducimus aperiam neque enim! Quas culpa dolorum ipsam? Ipsum voluptatibus numquam natus? Eligendi explicabo eos, perferendis voluptatibus hic sed ipsam rerum maiores officia! Beatae, molestias!</p>
				</div> <!-- cd-faq-content -->
			</li>
			<li>
				<a class="cd-faq-trigger" href="#0">Does SinCoGenesDB has orthology data?</a>
				<div class="cd-faq-content">
					<p>No. Tools and methods that SinCoGenesDB offers you, are about similarity of genes and sequences belong to a genome not similarities between genomes. Also, note that trees that SinCoGenesDB show you in Blast and Analyze are product of probable orthology between genomes, and are not proof of orthology relationship. </p>
				</div> <!-- cd-faq-content -->
			</li>
		</ul> <!-- cd-faq-group -->

		<ul id="search" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Database content</h2></li>
			<li>
				<a class="cd-faq-trigger" href="#0">What I will find in this database</a>
				<div class="cd-faq-content">
		...
		<ul id="blast" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Blast and Analyze data</h2></li>
			<li>
		...
		<ul id="browse" class="cd-faq-group">
			<li class="cd-faq-title"><h2>Browse and download data</h2></li>
			<li>
		...
		<ul id="cite" class="cd-faq-group">
			<li class="cd-faq-title"><h2>How to Cite</h2></li>
			<li>
